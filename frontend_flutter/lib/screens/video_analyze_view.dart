...
class VideoAnalyzeView extends StatefulWidget {
  const VideoAnalyzeView({super.key});

  @override
  State<VideoAnalyzeView> createState() => _VideoAnalyzeViewState();
}

class _VideoAnalyzeViewState extends State<VideoAnalyzeView> {
        ...
        children: [
              ...
              children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        ...
                        gradient: LinearGradient(
                          colors: [
                            const Color(0xFF7C6CF9).withValues(alpha: 0.45),
                            const Color(0xFF7C6CF9).withValues(alpha: 0.15),
                          ],
                        ),
                      ),
                      child: const Icon(Icons.movie_creation_rounded, size: 32, color: Colors.white),
                    ),
                    ...
                    Expanded(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Upload a clip · YOLO on the backend',
                ...
                Center(
                  child: FabGlass(
                    ...
                    label: 'Choose video',
                    onPressed: () => runAnalysisWorkflow(context, isVideo: true),
                  ),
                ),
              ],
            ),
          ...
          Row(
            children: [
              ...
              TextButton(
                onPressed: () => context.read<AnalysisHistoryProvider>().clearKind(AnalysisKind.video),
                child: Text(
                  'Clear',
          ...
          Consumer<AnalysisHistoryProvider>(
            builder: (context, h, _) {
              final all = h.byKind(AnalysisKind.video);
              ...
              return Column(
                children: items.map((e) {
                  final label = e.sourceFileName ?? 'Video file';
                  return Padding(
                    padding: const EdgeInsets.only(bottom: 10),
                    child: _HistoryRunTile(
                      fileLabel: label,
...
class _HistoryRunTile extends StatelessWidget {
  const _HistoryRunTile({
        ...
        child: Ink(
          ...
          child: Padding(
            ...
            child: Row(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Icon(Icons.movie_outlined, color: const Color(0xFF7C6CF9).withValues(alpha: 0.9)),
